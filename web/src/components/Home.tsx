  ...
  return (
    <main className="min-h-dvh bg-neutral-50 px-5 py-16 text-neutral-950 dark:bg-neutral-950 dark:text-neutral-50">
      <div className="mx-auto max-w-2xl">
        ...
        >
{`diffs
diffs /org/repo/pull/123
diffs https://github.com/org/repo/pull/123
diffs --github-host github.example.com /org/repo/pull/123
diffs --host localhost --port 4321 --cwd /path/to/repo`}
        </pre>
      </div>
    </main>
  );
